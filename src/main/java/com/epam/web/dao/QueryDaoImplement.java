...
public class QueryDaoImplement extends AbstractDao<Integer, Query> implements QueryDao {
    ...
    public static final String SQL_UPDATE_QUERY =
            "UPDATE query SET city=?, birthday = ?, school=?, medal=?  WHERE query_id = ?";
    public static final String SQL_FULL_INFO_QUERY="SELECT name,surname,role,query.query_id,city,birthday,school,medal,specialization_id,first_exam,second_exam,third_exam,grade\n" +
